...
int main()
{
    map<string, int , maComparaison> m = {{"a", 1}, {"b", 2}, {"c", 3}};
    for (const auto &[key, value] : m)
    {
        cout << key << " : " << value << endl;
    }
    // auto it = m.find("b");
    // auto extracted = m.extract(it);
    // extracted.key() = "d";
...
// {
// public:
//     virtual unique_ptr<Copiable> copier() const = 0;
//     virtual ~Copiable() = default;
// };

// class Personne : public Copiable
// {
// public:
//     Personne(const string &nom, int age) : nom_(nom), age_(age) {}

//     // clone générique (interface)
//     unique_ptr<Copiable> copier() const override
//     {
//         return make_unique<Personne>(*this);
//     }

//     // clone spécifique (IMPORTANT)
//     virtual unique_ptr<Personne> clonePersonne() const
//     {
//         return make_unique<Personne>(*this);
//     }
...
//     friend ostream &operator<<(ostream &os, const Personne &perso);
...
// {
// public:
//     Etudiant(const string &nom, int age, double moyenne)
//         : Personne(nom, age), moyenne_(moyenne) {}

//     unique_ptr<Copiable> copier() const override
//     {
//         return make_unique<Etudiant>(*this);
//     }

//     unique_ptr<Personne> clonePersonne() const override
//     {
//         return make_unique<Etudiant>(*this);
//     }
...
// class Profeseur : public Personne
// {
// public:
//     Profeseur(const string &nom, int age, const string &domaine)
//         : Personne(nom, age), domaine_(domaine) {}

//     unique_ptr<Copiable> copier() const override
//     {
//         return make_unique<Profeseur>(*this);
//     }
...
// ostream &operator<<(ostream &os, const Personne &perso)
// {
//     perso.afficher(os);
//     return os;
// }
...
// int main()
// {
//     vector<unique_ptr<Personne>> personnes;

//     personnes.push_back(make_unique<Etudiant>("raoul", 11, 18));
//     personnes.push_back(make_unique<Profeseur>("marc", 18, "beyblade"));

//     vector<unique_ptr<Personne>> copie;

//     for (auto &p : personnes)
//     {
//         cout << p << endl;
//         copie.push_back(unique_ptr<Personne>(dynamic_cast<Personne*>(p->copier().release())));
//     }
